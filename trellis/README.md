...
1. Review the automatically created site in `group_vars/development/laravel_sites.yml`
...
1. Configure your WordPress sites in `group_vars/<environment>/laravel_sites.yml` and in `group_vars/<environment>/vault.yml` (see the [Vault docs](https://docs.roots.io/trellis/master/vault/) for how to encrypt files containing passwords)
...
1. Add the `repo` (Git URL) of your Bedrock WordPress project in the corresponding `group_vars/<environment>/laravel_sites.yml` file
