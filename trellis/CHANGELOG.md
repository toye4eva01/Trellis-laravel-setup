...
* Disallow duplicate site keys within a host's `laravel_sites` ([#910](https://github.com/roots/trellis/pull/910))
...
* Add vault_laravel_sites validation ([#823](https://github.com/roots/trellis/pull/823))
...
* Simplify and improve `laravel_sites` with better defaults ([#528](https://github.com/roots/trellis/pull/528))
...
* Add `run_composer` option to `laravel_sites` so Composer can be run on the VM removing the requirement for it on the host
